...
additive_realizer = AdditiveRealizer(lattice)

# normal realizer without additivity constraints
dim, realizer = additive_realizer.normal_realizer()
DimDraw(lattice, realizer).plot_rotating_3d()